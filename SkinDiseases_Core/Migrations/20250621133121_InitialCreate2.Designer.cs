...
namespace SkinScan_Core.Migrations
{
    ...
    [Migration("20250621133121_InitialCreate2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SkinScan_Core.Entites.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SkinScan_Core.Entites.Patient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SkinScan_Core.Entites.PationDiagnosis", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SkinScan_Core.Entites.Message", b =>
                {
                    b.HasOne("SkinScan_Core.Contexts.ApplicationUser", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SkinScan_Core.Contexts.ApplicationUser", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("SkinScan_Core.Entites.PationDiagnosis", b =>
                {
                    b.HasOne("SkinScan_Core.Contexts.ApplicationUser", null)
                        .WithMany("Diagnoses")
